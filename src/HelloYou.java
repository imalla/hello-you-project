...
public class HelloYou {
	...
	public static void main(String[] args) {
		...
		System.out.println("Hello, and welcome to the SQA Selenium Boot Camp");
		// Request the user's name
		System.out.println("Could I please get your name?");
		// Set the captured name to a local String variable, name
		name = scanner.nextLine();
		// Call method to get user input and ser it to a variable which holds an
		// array of Strings
	...
	public static void outputUserDetails(String name) {
		// Begin outputting the user gathered details such as their name
		...
		for (int i = userVars.length - 1; i >= 0; i--) {
			// Echo detail gathered of usr info and requested details to console
